...
public class FasciaMain implements PlugIn
{
    ...
    public FasciaMain()
    {
        ...
        colors = new Color[ RoiManager.MAX_NUM_CLASSES ];
        ...
        for(int i = 0 ; i < RoiManager.MAX_NUM_CLASSES; i++)
        {
            ...
            exec.submit(new Runnable() {
                ...
                public void run()
                {
                    ...
                    //TODO Add checking for correct coordinate file.
                       ...
                       //imageRoi.setComposite(transparency050);
                        IJ.log(displayImage.getCurrentSlice() + " - Current Slice");
                        classifiedImages[displayImage.getCurrentSlice()] =  IJ.openImage();
                        //ImageProcessor ip = classifiedImages[displayImage.getCurrentSlice()].getProcessor();
                        ...
                        //Create Overlay from image

                        //Add to image and reset draw
                        /*
                        ...
                        if(returnValue == JFileChooser.APPROVE_OPTION) {
                            ...
                            try{
                                ...
                                displayImage.setRoi(fileRegion, true);

                                String[] classNames = new String[roiManager.getNumOfClasses()];
                                for(int i = 0; i < roiManager.getNumOfClasses(); i++)
                                {
                                    classNames[i] = roiManager.getClassLabel(i);
                                }
    ...
    private class CustomWindow extends StackWindow
    {
        ...
        CustomWindow(ImagePlus imp)
        {
            ...
            for(int i = 0; i < roiManager.getNumOfClasses(); i++)
            {
                ...
                addExampleButton[i] = new JButton("Add to " + roiManager.getClassLabel(i));
                addExampleButton[i].setToolTipText("Add markings of label '" + roiManager.getClassLabel(i) + "'");
            ...
            for(int i = 0; i < roiManager.getNumOfClasses(); i++)
            {
                ...
                showClassCheckBox[i] = new JCheckBox("Add to " + roiManager.getClassLabel(i));
                showClassCheckBox[i].setToolTipText("Add markings of label '" + roiManager.getClassLabel(i) + "'");
        ...
        protected RoiManager getRoiManager(){
            return roiManager;
        }
        ...
        protected void drawExamples()
        {
            ...
            for(int i = 0; i < roiManager.getNumOfClasses(); i++)
            {
                ...
                for (Roi r : roiManager.getRoiList(i, currentSlice))
                {
                    rois.add(r);
        ...
        protected void updateExampleLists()
        {
            ...
            for(int i = 0; i < roiManager.getNumOfClasses(); i++)
            {
                ...
                for(int j=0; j<roiManager.getRoiList(i, currentSlice).size(); j++)
        ...
        public void addClass()
        {
            ...
            addExampleButton[classNum] = new JButton("Add to " + roiManager.getClassLabel(classNum));
        ...
        protected void updateButtonsEnabling()
        {
            ...
            else // If the training is not going on
            {
                ...
                addClassButton.setEnabled(roiManager.getNumOfClasses() < WekaSegmentation.MAX_NUM_CLASSES);
        ...
        {
            int wekaNumOfClasses = roiManager.getNumOfClasses();
    ...
    public void run(String arg)
    {
        ...
        roiManager = new RoiManager(trainingImage);
        ...
        numOfClasses = roiManager.getNumOfClasses();
        ...
        //Initialise the classifiedImages array of Image Plus objects
    ...
    private void toggleClassOverlay(int classNum, boolean toggle){
        displayImage.killRoi();
        IJ.log("Toggling class" + roiManager.getClassLabel(classNum));
        if(toggle){
    ...
    public void updateResultOverlay()
    {
        ...
        if ( classifiedImages[displayImage.getCurrentSlice()] != null ) {
            ImageProcessor overlay = classifiedImages[displayImage.getCurrentSlice()].getProcessor().duplicate();
    ...
    void listSelected(final ItemEvent e, final int i)
    {
        ...
        for(int j = 0; j < roiManager.getNumOfClasses(); j++)
        {
            if (j == i)
            {
                final Roi newRoi =
    ...
    {
        if(roiManager.getNumOfClasses() == WekaSegmentation.MAX_NUM_CLASSES)
        {
        ...
        wekaSegmentation.setClassLabel(roiManager.getNumOfClasses(), inputName);
            ...
            String nSlice)
    {
        ...
        if( iw instanceof CustomWindow )
        {
            ...
            final RoiManager roiManager = win.getRoiManager();
            final Roi roi = win.getDisplayImage().getRoi();
            roiManager.addRoi(Integer.parseInt(classNum),
            ...
            String index)
    {
        ...
        if( iw instanceof CustomWindow )
        {
            final CustomWindow win = (CustomWindow) iw;
            final RoiManager roiManager = win.getRoiManager();
            roiManager.deleteRoi(Integer.parseInt(classNum),
    ...
    public static void changeClassName(String classIndex, String className)
    {
        ...
        if( iw instanceof CustomWindow )
        {
            ...
            roiManager.setClassLabel(classNum, className);
            win.updateAddClassButtons();
            win.pack();
        }
    }
